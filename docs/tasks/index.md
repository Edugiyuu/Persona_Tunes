...
last_assessed: 2026-09-16
portfolio_completion: 83
---
...
| RT-UI-005 | [Add an optional Elizabeth-guided navigation tutorial across the first run](./rt-ui-005-elizabeth-navigation-guide.md) | in-review | 16/16 (100%) | Behaviour built, green (92 tests, was 61) and walked end to end in the browser against the running API. Her long speeches now run several boxes, dismissed by a click or a key (AC-15); a mode she is merely describing is lit but not pressable, and the final box lights both and lets the player choose (AC-16). |
...
**Portfolio completion:** 83% (equal-weight mean of the six tasks in play: 100%, 100%, 100%, 100%, 0%, 100%). RT-UI-002 is paused and excluded.
