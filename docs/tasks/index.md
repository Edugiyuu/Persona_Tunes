...
| RT-UI-005 | [Add an optional Elizabeth-guided navigation tutorial across the first run](./rt-ui-005-elizabeth-navigation-guide.md) | in-review | 14/14 (100%) | Behaviour built, green (81 tests, was 61) and walked end to end in the browser against the running API. Ships no look — only `spotlight.css` mechanics — so the visual pass is the owner's. |
